...
public class SellerDao extends AbstractDao<Seller, Long> {
    ...
    */
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, Seller entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, Seller entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final Long updateKeyAfterInsert(Seller entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
